...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyAyjeZ4IO8daAM1vdsJj4y5geKnHgzK2Bw");
  ...
  void _autoLogout() {
    ...
    _authTimer = Timer(Duration(seconds: timeToExpire), loggout);
  }
